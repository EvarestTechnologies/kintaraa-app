...
export default function PoliceMessagesScreen() {
  const { assignedCases, isLoading } = useProvider();

  // Only show cases that have been accepted (conversation can exist)
  const acceptedCases = assignedCases.filter(
          ...
          acceptedCases.map((incident) => (
            ...
            >
              ...
              <View style={styles.caseInfo}>
                ...
                <Text style={styles.caseType}>{incident.type_display ?? incident.type}</Text>
                <View style={styles.caseFooter}>
                  ...
                  <View style={[styles.statusBadge, incident.status === 'in_progress' && styles.statusBadgeActive]}>
